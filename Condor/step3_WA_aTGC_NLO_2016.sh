...
scram b
cd ../../
#cmsDriver.py step1 --fileout file:SMP-RunIISummer16MiniAODv3-00370.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mcRun2_asymptotic_v3 --step PAT --era Run2_2016,run2_miniAOD_80XLegacy --python_filename SMP-RunIISummer16MiniAODv3-00370_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 100 || exit $? ; 

inFile=$1
outFile=`basename ${inFile}`
outFile=${outFile/s2_2_/s3_}
cfgFile=${outFile/.root/_cfg.py}
...
# with command line options: step1 --fileout file:SMP-RunIISummer16MiniAODv3-00370.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mcRun2_asymptotic_v3 --step PAT --era Run2_2016,run2_miniAOD_80XLegacy --python_filename SMP-RunIISummer16MiniAODv3-00370_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 100
